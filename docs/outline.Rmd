...
\subsubsection{Intuitive formulation}
...
\subsubsubsection{Are traits distributed normally within colonies?}
...
\subsubsubsection{Are colony means distributed normally about mu?}

\subsubsubsection{Are log(colony sd)'s distributed normally about delta?}
...
\section{Background}
\subsection{Within-colony variation}
...
sum(wkr_samples < sd_true)/length(wkr_samples)
```
