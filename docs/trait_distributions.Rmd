...
In contrast, most of the relative traits (top row) show markedly narrower distributions of colony means compared to worker traits. This indicates that for traits like **pronotal expansion**, each colony has workers that are quite variable. This seems to hold across species for these traits, rather than being clustered only within some species. **DVE** and **head shape** seem to be somewhat intermediate, with some differences among colony means. 
...
- Does variability within colonies seem to differ by species or by trait?  
    - Yes. Species-level CVs are higher for absolute traits, and particularly color, with values as high as 20%. Intra-colony CV is also very low for some relative traits like **scape proportion**, **DVE**, and **head shape**, but notably higher for **color**.
